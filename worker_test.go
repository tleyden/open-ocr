...
func TestWorkerOld(t *testing.T) {

	logg.LogTo("TEST", "testWorker")
	assert.True(t, true)
	...
	if err != nil {
		logg.LogTo("TEST", "Get error publishing: %v", err)
	}
	logg.LogTo("TEST", "Published msg ok")
